...
def merge_sort(linked_list):
    """
    Sorts a linkd list in ascending order
...
def merge(left, right):
    ...
    # iterate over left and right until we reach the tail node of item
    while left_head or right_head:
        ...
        # add the tail node from the left to merged linked list
            ...
            if left_data < right_data:
                ...
                left_head = left_head.next_node
            # if left data is greater than right data, asign current to right node
            else:
                current.next_node = right_head
